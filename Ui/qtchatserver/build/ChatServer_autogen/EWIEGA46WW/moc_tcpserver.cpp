...
QT_MOC_LITERAL(7, 70, 12), // "onNewMessage"
QT_MOC_LITERAL(8, 83, 2), // "ba"
QT_MOC_LITERAL(9, 86, 14) // "onDisconnected"

    },
    "TcpServer\0newMessage\0\0message\0sendMessage\0"
    "onNewConnection\0onReadyRead\0onNewMessage\0"
    "ba\0onDisconnected"
};
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onNewMessage((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpServer::newMessage)) {
                *result = 0;
                return;
            }
        }
